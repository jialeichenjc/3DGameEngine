...
public:
	...
	AxisAlignedBoundingBox(Vector3D * i_max, Vector3D * i_min) {
		m_MaxPosition = i_max;
		m_MinPosition = i_min;
	}
	...
	inline void SetMaxPosition(Vector3D * i_max) { m_MaxPosition = i_max; }
	inline void SetMinPosition(Vector3D * i_min) { m_MinPosition = i_min; }
